<?php
/**
 * Teleborgs VVS AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Teleborgs VVS AB Leads" plugin, so leads survive a theme change.
 *
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'teleborgsvvs', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'teleborgsvvs' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'teleborgsvvs' ) ) );

		register_block_pattern_category( 'teleborgsvvs-sections', array( 'label' => __( 'Teleborgs VVS AB sections', 'teleborgsvvs' ) ) );
		register_block_pattern_category( 'teleborgsvvs-pages', array( 'label' => __( 'Teleborgs VVS AB page layouts', 'teleborgsvvs' ) ) );
	}
);
