...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'teleborgsvvs-leads' ),
				'storm'       => __( 'Storm or hail damage', 'teleborgsvvs-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'teleborgsvvs-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'teleborgsvvs-leads' ),
				'not-sure'    => __( 'Vet inte än', 'teleborgsvvs-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'teleborgsvvs-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'teleborgsvvs-leads' ),
				'research' => __( 'Jag kollar bara priser', 'teleborgsvvs-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'teleborgsvvs-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'teleborgsvvs-leads' ),
		'contacted' => __( 'Kontaktad', 'teleborgsvvs-leads' ),
		'quoted'    => __( 'Quote sent', 'teleborgsvvs-leads' ),
		'won'       => __( 'Won', 'teleborgsvvs-leads' ),
		'lost'      => __( 'Lost', 'teleborgsvvs-leads' ),
		'spam'      => __( 'Misstänkt spam', 'teleborgsvvs-leads' ),
	);
}
